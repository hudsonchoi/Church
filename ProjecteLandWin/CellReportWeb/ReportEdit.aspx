...
<%@ Register assembly="BulkEditGridView" namespace="BulkEditGridView" tagprefix="cc2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
       ...
       <asp:Label ID="Label2" runat="server" Text=""> </asp:Label>&nbsp;</td>
        <td align="right" class="style2">
         <a href="Default.aspx">   <img src="images/bttn_list.gif" border="0" style="width: 141px; height: 25px" /></a></td>
          <td align="right" width="90">    <asp:ImageButton ID="btn_edit2" runat="server" 
                                                ImageUrl="~/images/bttn_edit.gif" onclick="btn_edit_Click" />
    ...
    <tr><td class="ContentBox3" align="left" ><span style="padding-left:10px;">순원 사항</span></td></tr>
    <tr><td>
    
       
            <asp:ListView ID="list_details" runat="server">
            </asp:ListView>
        ...
        <tr ><td class="ContentBox1">
              <asp:TextBox ID="txtmemo" runat="server" Height="100px" TextMode="MultiLine"  CssClass="inputArea"
                  Width="720px"></asp:TextBox>
                        ...
                        </asp:UpdatePanel> <tr><td style=" padding-top:5px;"><table  width="730" border="0" cellspacing="0" cellpadding="0">
                                    <tr><td class="style1">
                                        
                                        </td>
                                        <td class="style1" align="right" >
                                            <asp:ImageButton ID="ImageButton1" runat="server" 
                                            ImageUrl="~/images/bttn_print.gif" />
