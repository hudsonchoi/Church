...
{
    [Serializable()]
    public class Baptism : BusinessBase<Baptism>
    {
        private int     _id;
        private bool    _idSet;
        ...
        public int ID
        {
            get
            {
                ...
                {
                    _idSet = true;
                    Baptisms parent = (Baptisms)this.Parent;
                    int max = 0;
                    foreach (Baptism item in parent)
                    {
                        if (item.ID > max)
                            max = item.ID;
                    }
        ...
        internal static Baptism Get(SafeDataReader dr)
        {
            return new Baptism(dr);
        }

        internal static Baptism New()
        {
            return new Baptism();
        }
        private Baptism()
        ...
        private Baptism(SafeDataReader dr)
        {
            MarkAsChild();
            _idSet = true;
            _id = dr.GetInt32("id");
        ...
        internal void Insert(SqlConnection cn)
        {
            ...
            using (SqlCommand cm = cn.CreateCommand())
            {
                ...
                cm.CommandText = "app_admin.type_baptism_insert";
        ...
        internal void Update(SqlConnection cn)
        {
            ...
            {
                cm.CommandType = CommandType.StoredProcedure;
                cm.CommandText = "app_admin.type_baptism_update";
                cm.Parameters.AddWithValue("@name", _name);
        ...
        private void Delete(SqlConnection cn, int id,string username)
        {
            ...
            {
                cm.CommandType = CommandType.StoredProcedure;
                cm.CommandText = "app_admin.type_baptism_delete";
