...
{
    public partial class CellListFrm : Form
    {
        private _entity.Cells _list;

        public CellListFrm()
        {
            InitializeComponent();
            this.cellListBindingSource.DataSource = _entity.CellList.Get(false);
            LoadData();
        }
        ...
        {
            this.cellsBindingSource.DataSource = from list in _list
                                                     where list.Status != "D"
        ...
        private void SaveData()
        {
            ...
            _entity.Cells temp = _list.Clone();
            temp.ApplyEdit();
            try
            {
                _list = temp.Save();
                MessageBox.Show(Properties.Resources.Success_Save);
                this.cellsBindingSource.DataSource = _list;
                this.cellsBindingSource.ResetBindings(true);
        ...
        private void btnSave_Click(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (!_entity.Cells.CanEditObject())
            {
        ...
        private void btnRemove_Click(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (_entity.Cells.CanDeleteObject())
            {
        ...
        private void Remove(object[] row)
        {
            ...
            {
                _list.Remove(obj as _entity.Cell);
            }
        }
    }
}
