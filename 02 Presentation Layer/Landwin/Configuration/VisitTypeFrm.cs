...
{
    public partial class VisitTypesFrm : Form
    {
        private _entity.VisitTypes _list;
        public VisitTypesFrm()
        {
            InitializeComponent();
            this.Text = Resources.VisitType;
        ...
        private void LoadData()
        {
            try
            {
                _list = _entity.VisitTypes.GetList();
                _list.BeginEdit();
                this.visitTypesBindingSource.DataSource = _list;
        ...
        {
            this.visitTypesBindingSource.RaiseListChangedEvents = false;
            ...
            _entity.VisitTypes temp = _list.Clone();
            temp.ApplyEdit();
            try
            {
            ...
            {
                this.visitTypesBindingSource.RaiseListChangedEvents = true;
            }
        }

        private void btnSave_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (!_entity.Baptisms.CanEditObject())
            {
            ...
            this.visitTypesBindingSource.EndEdit();
            if (!_list.IsValid)
            {
                MessageBox.Show(Properties.Resources.ErrorMessage_Invalid);
                return;
        ...
        {
            if (_list.IsDirty && _entity.Baptisms.CanEditObject())
            {
        ...
        private void btnRemove_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (_entity.Baptisms.CanDeleteObject())
            {
        ...
        private void btnAdd_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                _list.AddNew();
                this.visitTypesBindingSource.ResetBindings(false);
            }
            else
            {
                MessageBox.Show(Properties.Resources.ErrorMessage_Invalid);
        ...
        private void Remove(object[] row)
        {
            ...
            {
                _list.Remove(obj as _entity.VisitType);
            }
        }
    }
}
